...
class DSC_OT_junction(bpy.types.Operator):
    ...
    def create_object_xodr(self, context, point_start, point_end, snapped_start):
        ...
        obj['point_down'] = obj.location + obj.data.vertices[0].co
        obj['point_left'] = obj.location + obj.data.vertices[2].co
        obj['point_up'] = obj.location + obj.data.vertices[4].co
        obj['point_right'] = obj.location + obj.data.vertices[6].co
        ...
        obj['t_junction_planView_geometry_y'] = point_end.y
