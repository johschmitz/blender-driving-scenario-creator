...
params_cross_section = {
    ...
    'on_ramp_end': {
        ...
        'widths_start': [1.5, 3.0, 0.75, 0.0, 3.75],
        'widths_end': [1.5, 3.0, 0.75, 0.0, 3.75],
    ...
    'on_ramp_shoulder_end': {
        'sides': ['left', 'left', 'left', 'center', 'right', 'right', 'right'],
        'widths_start': [1.5, 3.0, 0.75, 0.0, 3.75, 0.75, 1.5],
        'widths_end': [1.5, 3.0, 0.75, 0.0, 3.75, 0.75, 1.5],
    ...
    'off_ramp_begin': {
        ...
        'widths_start': [3.75, 0.0, 0.75, 3.0, 1.5],
        'widths_end': [3.75, 0.0, 0.75, 3.0, 1.5],
    ...
    'off_ramp_shoulder_begin': {
        'sides': ['left', 'left', 'left', 'center', 'right', 'right', 'right'],
        'widths_start': [1.5, 0.75, 3.75, 0.0, 0.75, 3.0, 1.5],
        'widths_end': [1.5, 0.75, 3.75, 0.0, 0.75, 3.0, 1.5],
