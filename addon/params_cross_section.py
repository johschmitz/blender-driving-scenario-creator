...
params_cross_section = {
    ...
    'on_ramp_end': {
        ...
        'widths_end': [1.5, 3.0, 0.75, 3.75, 0.0],
    ...
    'on_ramp_shoulder_end': {
        'sides': ['left', 'left', 'left', 'left', 'center', 'right', 'right'],
        'widths_start': [1.5, 3.0, 0.75, 3.75, 0.0, 0.75, 1.5],
        'widths_end': [1.5, 3.0, 0.75, 3.75, 0.0, 0.75, 1.5],
        'types': ['shoulder', 'stop', 'border', 'offRamp', 'center', 'border', 'shoulder'],
