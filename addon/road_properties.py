...
class DSC_road_properties(bpy.types.PropertyGroup):
    ...
    cross_section_preset: bpy.props.EnumProperty(
            items=(
                ...
                ('eka1_rq31_exit_right_branch', 'EKA 1, RQ 31 - exit right branch', 'EKA 1, RQ 31 - exit right branch'),
                ...
                ('eka1_rq31_entry_right_merge', 'EKA 1, RQ 31 - entry right merge', 'EKA 1, RQ 31 - entry right merge'),
